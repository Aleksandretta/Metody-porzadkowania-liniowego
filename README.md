...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;W celu porównania rankingów obliczonych przy pomocy różnych metod porządkowania liniowego obiektów, przygotowano macierze korelacji metod porządkowania liniowego obiektów odpowiednio dla analiz przeprowadzonych na danych przybliżanych metodą winsoryzacji (Wykres 5.3) oraz metodą k-sąsiadów (k=5) (Wykres 5.4) oraz wektor porówujący korelacje w obrębie tej samej metody porządkowania liniowego, dla różnych metod obsłużenia wartości odstających. Wartości podane w macierzach oraz współrządne wektora są wartościami współczynnika korelacji Pearsona.
